  ...
  return (
    <section className=" flex-grow h-full flex flex-col items-center justify-center m-4 p-6">
      <div className="text-center h-full">
        <BiCart className="text-[#41C7BA] w-24 h-24 mx-auto mb-4" />
        ...
        <button
          ...
          className="inline-block max-[350px]:text-sm max-[350px]:py-2 max-[350px]:px-4 px-6 py-3 bg-[#41C7BA] text-white  rounded-full hover:bg-blue-700 transition">
          Shop Now
        </button>
      </div>
    </section>
